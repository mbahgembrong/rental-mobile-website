...
@else
    ...
    <li class="nav-item {{ Request::is('admin/sopirs*') ? 'active' : '' }}">
        <a class="nav-link" href="{{ route('sopirs.index') }}">
            <i class="nav-icon fa fa-id-card"></i>
            <span>Data Sopir</span>
        </a>
    </li>
    <li class="nav-item {{ Request::is('admin/kategoriMobils*') ? 'active' : '' }}">
        <a class="nav-link" href="{{ route('kategoriMobils.index') }}">
            <i class="nav-icon fa fa-tags"></i>
            <span>Kategori Mobil</span>
        </a>
    </li>
    <li class="nav-item {{ Request::is('admin/mobils*') ? 'active' : '' }}">
